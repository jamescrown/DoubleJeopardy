...
public class Board {
	...
	Board () {
		...
		squares[5] = new Property("King's Cross Station", 200, new int[] {25,50,100,200,200,200}, "TRANSPORT");
		...
		squares[12] = new Property("Electric Co", 150, new int[] {4,10,0,0,0,0}, "UTILITIES");
		...
		squares[15] = new Property("Marylebone Station", 200, new int[] {25,50,100,200,200,200}, "Transport");
		...
		squares[25] = new Property("Fenchurch St Station", 200, new int[] {25,50,100,200,200,200}, "TRANSPORT");
		...
		squares[28] = new Property("Water Works", 150, new int[] {4,10,0,0,0,0}, "UTILITIES");
		...
		squares[35] = new Property("Liverpool St Station", 200, new int[] {25,50,100,200,200,200}, "TRANSPORT");
